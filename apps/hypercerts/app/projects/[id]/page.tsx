              ...
              <div className="grid gap-6 md:grid-cols-2">
                {parentVault && (
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Sends {vault?.percent ? Number(vault.percent) / 100 : 0}
                        % upstream
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                {childrenVaults && childrenVaults.length > 0 && (
                  <Card>
                    <CardHeader>
                      <CardTitle>
                        Child Vaults ({childrenVaults.length})
                      </CardTitle>
                      <CardDescription>
                        Vaults sending funding upstream
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-2">
                      {childrenVaults.slice(0, 3).map((child: any) => (
                        <Link
                          key={child.id}
                          href={`/certs/${child.id}`}
                      ...
                      {childrenVaults.length > 3 && (
                        <div className="text-sm text-muted-foreground text-center pt-2">
                          +{childrenVaults.length - 3} more
                        </div>
                      )}
                    </CardContent>
                  </Card>
